...
class MPNEncoder(nn.Module):
    ...
    def __init__(self, args: Namespace, atom_fdim: int, bond_fdim: int):
        ...
        self.directed = getattr(args, 'directed', False)  # D-MPNN flag
    ...
    def forward(
        ...
        # print(components)
        f_atoms, f_bonds, a2b, b2a, b2revb, a_scope, b_scope, b2b, a2a = components
        ...
        if self.atom_messages:
            for _ in range(self.depth - 1):
                # D-MPNN: skip undirected symmetrization for directed message passing
                if self.undirected and not self.directed:
...
class MPN(nn.Module):
    ...
    def forward(
        self,
        batches: Union[List[List[str]], List[List[Chem.Mol]], List[Tuple]],
